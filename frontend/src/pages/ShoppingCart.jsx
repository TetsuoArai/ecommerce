...
function ShoppingCart() {
  ...
  const ch = (siz) => {
    setSelectedSize(prevSize => prevSize === siz ? null : siz);
  };
    ...
    <div className="w-full h-screen flex justify-center items-center ">
      <SignedIn>
        <div className="w-auto">
          <div className="card shadow md:shadow-none lg:card-side bg-base-10 xl:shadow-xl max-w-[150vh] max-h-[90vh]">
            <img
            ...
            <div className="card-body max-w-[300vh] ml-5 md:top-[200px]">
