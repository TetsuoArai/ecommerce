      ...
      <div className="flex justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3">
          {currentPosts.map((product) => (
            <div
              className="rounded-xl m-1 shadow-xl shadow-black-500/50 border-none mt-7 mr-5 inline-block 2xl:max-h-[560px] xl:max-h-[540px] md:h-auto lg:h-auto"
              key={product.id}>
              ...
              <Stack
                direction="row"
                spacing={4}
                className="flex items-center justify-center mt-2 mb-5">
                <Button
                  colorScheme="teal"
                  variant="solid"
                  className="w-[190px]">
