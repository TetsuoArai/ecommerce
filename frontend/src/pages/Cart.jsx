...
function Cart() {
    ...
    function deleteData(model, size){
        console.log(model, size)
        // setItems(items.filter((product) => product.model.trim() !== model && product.size.trim() === size));
        // console.log(items)
        // localStorage.setItem(user.id, JSON.stringify(items))
                    ...
                    <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                      ...
                      <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <button onClick={()=>deleteData(product.model, product.size)}>
                          <svg
